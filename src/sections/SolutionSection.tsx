        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {solutions.map((s, i) => {
            ...
            return (
              <div
                key={i}
                className="group relative rounded-3xl p-7 transition-all duration-300 hover:-translate-y-1.5 cursor-default overflow-hidden"
                style={{
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/70 text-sm leading-relaxed mt-3">{s.text}</p>
                </div>
              </div>
            );
          })}
